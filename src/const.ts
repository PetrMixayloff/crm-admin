...
export const MeasureUnits = [
  { code: '003', name: 'Миллиметр', caption: 'мм' },
  { code: '004', name: 'Сантиметр', caption: 'см' },
  { code: '005', name: 'Дециметр', caption: 'дм' },
  { code: '006', name: 'Метр', caption: 'м' },
  { code: '008', name: 'Километр', caption: 'км' },
  { code: '018', name: 'Погонный метр', caption: 'пог. м' },
  { code: '039', name: 'Дюйм', caption: 'дюйм' },
  { code: '041', name: 'Фут', caption: 'фут' },
  { code: '043', name: 'Ярд', caption: 'ярд' },
  { code: '051', name: 'Квадратный сантиметр', caption: 'см²' },
  { code: '055', name: 'Квадратный метр', caption: 'м²' },
  { code: '112', name: 'Литр', caption: 'л' },
  { code: '113', name: 'Кубический метр', caption: 'м³' },
  { code: '161', name: 'Миллиграмм', caption: 'мг' },
  { code: '163', name: 'Грамм', caption: 'г' },
  { code: '166', name: 'Килограмм', caption: 'кг' },
  { code: '616', name: 'Бобина', caption: 'боб' },
  { code: '625', name: 'Лист', caption: 'л' },
  { code: '639', name: 'Доза', caption: 'д' },
  { code: '642', name: 'Единица', caption: 'ед' },
  { code: '657', name: 'Изделие', caption: 'изд' },
  { code: '715', name: 'Пара (2 шт.)', caption: 'пар' },
  { code: '728', name: 'Пачка', caption: 'пач' },
  { code: '735', name: 'Часть', caption: 'часть' },
  { code: '736', name: 'Рулон', caption: 'рул' },
  { code: '744', name: 'Процент', caption: '%' },
  { code: '778', name: 'Упаковка', caption: 'упак' },
  { code: '796', name: 'Штука', caption: 'шт' },
  { code: '810', name: 'Ячейка', caption: 'яч' },
  { code: '812', name: 'Ящик', caption: 'ящ' },
  { code: '839', name: 'Комплект', caption: 'компл' },
  { code: '840', name: 'Секция', caption: 'секц' },
  { code: '868', name: 'Бутылка', caption: 'бут' },
  { code: '872', name: 'Флакон', caption: 'флак' },
  { code: '876', name: 'Условная единица', caption: 'усл. ед.' }
]
